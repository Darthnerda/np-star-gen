(() => {
  ...
  var monadTransExceptT = {
    lift: function(dictMonad) {
      ...
      var pure10 = pure(dictMonad.Applicative0());
      return function(m) {
        return bind6(m)(function(a2) {
          return pure10(new Right(a2));
        });
      };
    }
  };
              ...
              function go2(bot, top3) {
                switch (top3 - bot) {
                  ...
                  default:
                    ...
                    return apply2(map24(concat2)(go2(bot, pivot)))(go2(pivot, top3));
                }
              }
  ...
  var foldr3 = /* @__PURE__ */ foldr(foldableList2);
  var traversableList = {
    traverse: function(dictApplicative) {
      var Apply0 = dictApplicative.Apply0();
      ...
      var pure10 = pure(dictApplicative);
      return function(f) {
        return foldr3(function(a2) {
          return function(b2) {
            return apply1(map24(cons)(f(a2)))(b2);
          };
        })(pure10(nil));
      };
    },
  ...
  var foldl2 = /* @__PURE__ */ foldl(foldableList2);
  var fix2 = /* @__PURE__ */ fix(lazyList);
  var append12 = /* @__PURE__ */ append(semigroupList2);
      ...
      return function(m) {
        ...
        if (otherwise) {
          return bind23(m)(function(a2) {
            return bind23(replicateM(dictMonad)(n - 1 | 0)(m))(function(as) {
              return pure14(cons(a2)(as));
            });
          });
        }
        ;
  ...
  var length2 = /* @__PURE__ */ foldl2(function(l) {
    return function(v) {
      return l + 1 | 0;
    };
  })(0);
  ...
  var cycle = function(xs) {
    return fix2(function(ys) {
      return append12(xs)(ys);
    });
  };
  ...
  var killFiber = function(e2) {
    return function(v) {
      return bind1(liftEffect2(v.isSuspended))(function(suspended) {
        if (suspended) {
          return liftEffect2($$void3(v.kill(e2, $$const(pure2(unit)))));
        }
        ;
        return makeAff(function(k) {
          return map6(effectCanceler)(v.kill(e2, k));
        });
      });
    };
  };
  ...
  var writeForeignArray = function(dictWriteForeign) {
    ...
    return {
      writeImpl: function(xs) {
        return unsafeToForeign(map21(writeImpl1)(xs));
      }
    };
  };
              ...
              return {
                writeImplFields: function(v) {
                  return function(rec) {
                    ...
                    var value14 = writeImpl1(get3($$Proxy.value)(rec));
                    var result = compose1(insert13($$Proxy.value)(value14))(rest);
                    return result;
                  };
                }
              };
  ...
  var bindExceptT2 = /* @__PURE__ */ bindExceptT(monadEffect);
  var discard12 = /* @__PURE__ */ discard5(bindExceptT2);
  var applicativeExceptT2 = /* @__PURE__ */ applicativeExceptT(monadEffect);
  var when4 = /* @__PURE__ */ when(applicativeExceptT2);
  var throwError3 = /* @__PURE__ */ throwError(/* @__PURE__ */ monadThrowExceptT(monadEffect));
  var bind5 = /* @__PURE__ */ bind(bindExceptT2);
  var traverse2 = /* @__PURE__ */ traverse(traversableList)(applicativeExceptT2);
  ...
  var discard32 = /* @__PURE__ */ discard5(bindStateT2);
  var put1 = /* @__PURE__ */ put(monadStateStateT2);
  var applicativeStateT2 = /* @__PURE__ */ applicativeStateT(monadIdentity);
  var pure13 = /* @__PURE__ */ pure(applicativeStateT2);
  var bind32 = /* @__PURE__ */ bind(/* @__PURE__ */ bindReaderT(bindStateT2));
  var monadStateT2 = /* @__PURE__ */ monadStateT(monadIdentity);
  var ask2 = /* @__PURE__ */ ask(/* @__PURE__ */ monadAskReaderT(monadStateT2));
  var lift3 = /* @__PURE__ */ lift(monadTransReaderT)(monadStateT2);
  var functorStateT2 = /* @__PURE__ */ functorStateT(functorIdentity);
  var map23 = /* @__PURE__ */ map(functorStateT2);
  ...
  var applicativeReaderT2 = /* @__PURE__ */ applicativeReaderT(applicativeStateT2);
  var pure23 = /* @__PURE__ */ pure(applicativeReaderT2);
  var map110 = /* @__PURE__ */ map(/* @__PURE__ */ functorReaderT(functorStateT2));
  var show1 = /* @__PURE__ */ show(showInt);
  var traverse12 = /* @__PURE__ */ traverse(traversableArray)(applicativeReaderT2);
  var append13 = /* @__PURE__ */ append(semigroupArray);
  var replicateM2 = /* @__PURE__ */ replicateM(monadEffect);
  ...
  var lift1 = /* @__PURE__ */ lift(monadTransExceptT)(monadEffect);
  ...
  var recordWriteForeign2 = /* @__PURE__ */ recordWriteForeign();
  var writeJSON2 = /* @__PURE__ */ writeJSON(/* @__PURE__ */ recordWriteForeign2(/* @__PURE__ */ consWriteForeignFields({
    reflectSymbol: function() {
      return "stars";
    }
  })(/* @__PURE__ */ writeForeignArray(/* @__PURE__ */ recordWriteForeign2(/* @__PURE__ */ consWriteForeignFields({
    reflectSymbol: function() {
      return "e";
    }
  })(writeForeignInt)(/* @__PURE__ */ consWriteForeignFields({
    reflectSymbol: function() {
      return "g";
    }
  })(writeForeignInt)(/* @__PURE__ */ consWriteForeignFields({
  ...
  })(writeForeignString)(/* @__PURE__ */ consWriteForeignFields({
    reflectSymbol: function() {
      return "puid";
    }
  })(/* @__PURE__ */ writeForeignMaybe(writeForeignInt))(/* @__PURE__ */ consWriteForeignFields({
    reflectSymbol: function() {
      return "r";
    }
  })(writeForeignInt)(/* @__PURE__ */ consWriteForeignFields({
  ...
  })(writeForeignNumber)(/* @__PURE__ */ consWriteForeignFields({
    reflectSymbol: function() {
      return "y";
    }
  })(writeForeignNumber)(nilWriteForeignFields)()()())()()())()()())()()())()()())()()())()()())()()())()()())()()())()()())))(/* @__PURE__ */ consWriteForeignFields({
    reflectSymbol: function() {
      return "wormholes";
    }
  })(/* @__PURE__ */ writeForeignArray(/* @__PURE__ */ writeForeignArray(writeForeignInt)))(nilWriteForeignFields)()()())()()()));
  var Slide = /* @__PURE__ */ function() {
    function Slide2(value0, value1) {
      this.value0 = value0;
      this.value1 = value1;
    }
    ;
    Slide2.create = function(value0) {
      return function(value1) {
        return new Slide2(value0, value1);
      };
    };
    return Slide2;
  }();
  ...
  var HandleSliderChange = /* @__PURE__ */ function() {
    function HandleSliderChange2(value0) {
      this.value0 = value0;
    }
    ;
    HandleSliderChange2.create = function(value0) {
      return new HandleSliderChange2(value0);
    };
    return HandleSliderChange2;
  }();
  var validateCircle = function(dictMonad) {
    var discard42 = discard5(bindExceptT(dictMonad));
    var when1 = when(applicativeExceptT(dictMonad));
    var throwError1 = throwError(monadThrowExceptT(dictMonad));
    return function(circle) {
      return discard42(when1(isNaNImpl(circle.center.x))(throwError1("Circle x value must not be NaN.")))(function() {
        return discard42(when1(isNaNImpl(circle.center.y))(throwError1("Circle y value must not be NaN.")))(function() {
          return discard42(when1(circle.radius < 0)(throwError1("Circle radius must be at least 0.")))(function() {
            return when1(circle.rotationsPerTick < 0)(throwError1("Circle RotationsPerTick must be at least 0."));
          });
        });
      });
    };
  };
  var validateCircle1 = /* @__PURE__ */ validateCircle(monadEffect);
  var validateConfig = function(config) {
    return discard12(when4(isNaNImpl(config.alpha))(throwError3("Alpha must not be NaN.")))(function() {
      return discard12(when4(isNaNImpl(config.beta))(throwError3("Beta must not be NaN.")))(function() {
        return discard12(when4(config.alpha < 0)(throwError3("Alpha must be at least 0.")))(function() {
          return discard12(when4(config.beta < 0)(throwError3("Beta must be at least 0.")))(function() {
            return discard12(when4(config.beta > 1)(throwError3("Beta must be at most 1.")))(function() {
              return discard12(when4(config.playerCount < 2)(throwError3("PlayerCount must be at least 2.")))(function() {
                return discard12(when4(config.starCount < 2)(throwError3("StarCount must be at least 2.")))(function() {
                  return discard12(when4(config.wormholeCount < 0)(throwError3("WormholeCount must be at least 0.")))(function() {
                    return discard12(when4(config.playerCount > config.starCount)(throwError3("StarCount must be greater than PlayerCount.")))(function() {
                      return discard12(when4(config.wormholeCount > config.starCount)(throwError3("StarCount must be greater than WormholeCount.")))(function() {
                        return bind5(traverse2(validateCircle1)(config.orbits))(function() {
                          return pure9(config);
                        });
                      });
                    });
  ...
  var updateStateByLabel = function(label5) {
    return function(newVal) {
      return function(state3) {
        if (label5 === "alpha") {
          return {
            galaxyJson: state3.galaxyJson,
            config: set2($$Proxy.value)(newVal)(state3.config)
          };
        }
        ;
        if (label5 === "beta") {
          return {
            galaxyJson: state3.galaxyJson,
            config: set1($$Proxy.value)(newVal)(state3.config)
          };
        }
        ;
        if (label5 === "scale") {
          return {
            galaxyJson: state3.galaxyJson,
            config: set22($$Proxy.value)(newVal)(state3.config)
          };
        }
        ;
        if (label5 === "playerCount") {
          return {
            galaxyJson: state3.galaxyJson,
            config: {
              alpha: state3.config.alpha,
              beta: state3.config.beta,
              scale: state3.config.scale,
              orbits: state3.config.orbits,
              starCount: state3.config.starCount,
              wormholeCount: state3.config.wormholeCount,
              playerCount: round2(newVal)
            }
          };
        }
        ;
        if (label5 === "starCount") {
          return {
            ...
            config: {
              ...
              beta: state3.config.beta,
              scale: state3.config.scale,
              playerCount: state3.config.playerCount,
              orbits: state3.config.orbits,
              wormholeCount: state3.config.wormholeCount,
              starCount: round2(newVal)
            }
          };
        }
        ;
        if (label5 === "wormholeCount") {
          return {
            galaxyJson: state3.galaxyJson,
            config: {
              alpha: state3.config.alpha,
  ...
  var unsafeFromJust = function(val) {
    return fromJust3(val);
  };
  var tickToRadian = function(time3) {
    return 2 * pi * time3;
  };
  var slider = function(dictMonadEffect) {
    var render = function(state3) {
      return div_([text5(state3.label), input2([value13(show3(state3.value)), type_19(InputRange.value), min5(state3.min), max6(state3.max), step4(new Step(state3.step)), onValueInput(function(newVal) {
        return new Slide(state3.label, unsafeFromJust(fromString(newVal)));
      })]), text5(show3(state3.value))]);
    };
    var handleAction = function(dictMonadEffect1) {
      var liftEffect7 = liftEffect(monadEffectHalogenM(dictMonadEffect1));
      return function(v) {
        return bind15(liftEffect7(log2("testing")))(function() {
          return bind15(gets2(function(v1) {
            return v1.label;
          }))(function(label1) {
            return discard23(raise(new Slide(label1, v.value1)))(function() {
  ...
  var sgMagic = /* @__PURE__ */ function() {
    return 1 + log(4.5);
  }();
  var retryUnlessM = function(dictMonad) {
    var bind52 = bind(dictMonad.Bind1());
    var pure42 = pure(dictMonad.Applicative0());
    return function(pred2) {
      return function(action2) {
        return bind52(action2)(function(res) {
          var $262 = pred2(res);
          if ($262) {
            return pure42(res);
          }
          ;
          return retryUnlessM(dictMonad)(pred2)(action2);
        });
      };
    };
  };
  var retryUnlessM1 = /* @__PURE__ */ retryUnlessM(monadStateT2);
  var retryUnlessM2 = /* @__PURE__ */ retryUnlessM(/* @__PURE__ */ monadReaderT(monadStateT2));
  var posOnCircle = function(circle) {
    return function(time3) {
      var rotation = tickToRadian(time3 * circle.rotationsPerTick);
      return {
        x: sin(rotation) * circle.radius + circle.center.x,
        y: cos(rotation) * circle.radius + circle.center.y
      };
    };
  };
  var log4 = /* @__PURE__ */ log(4);
  var jsonDisplay = /* @__PURE__ */ function() {
    var render = function(galaxyJson) {
      return div2([style("width: 700px; height: 500px; overflow: scroll;")])([text5(galaxyJson)]);
    };
    ...
    return mkComponent({
      ...
      "eval": mkEval({
        ...
        finalize: defaultEval.finalize,
        handleAction,
        receive: function($295) {
          return Just.create(Receive2.create($295));
        }
      })
    });
  }();
  ...
  var consume = /* @__PURE__ */ bind22(/* @__PURE__ */ gets(monadStateStateT2)(function($296) {
    return unsafeFromJust(uncons($296));
  }))(function(v) {
    return discard32(put1(v.tail))(function() {
      return pure13(v.head);
    });
  });
  var randStarIdx = /* @__PURE__ */ bind32(ask2)(function(v) {
    return lift3(map23(function(a2) {
      return round2(a2 * (toNumber(v.starCount) - 1));
    })(consume));
  });
  var rgamma = function(alpha) {
    return function(beta) {
      if (alpha > 1) {
        return bind22(retryUnlessM1(function(a2) {
          return and2([a2 > 1e-7, a2 < 0.9999999]);
        })(consume))(function(u1) {
          return bind22(map23(function(v) {
            return 1 - v;
          })(consume))(function(u2) {
            var z = u1 * u1 * u2;
            var bbb = alpha - log4;
            var ainv = sqrt(2 * alpha - 1);
            var ccc = alpha + ainv;
            var v = log(u1 / (1 - u1)) / ainv;
            var x = alpha * exp(v);
            var r = bbb + ccc * v - x;
            var $272 = or2([r + sgMagic - 4.5 * z > 0, r >= log(z)]);
            if ($272) {
              return pure13(x * beta);
            }
            ;
      ...
      ;
      if (alpha === 1) {
        return bind22(retryUnlessM1(function(v) {
          return v <= 1e-7;
        })(consume))(function(u2) {
          return pure13(beta * negate2(log)(u2));
        });
      }
      ;
      if (otherwise) {
        return bind22(consume)(function(u3) {
          return bind22(consume)(function(u4) {
            var b2 = (e + alpha) / e;
            var p2 = b2 * u3;
            var x = function() {
              var $273 = p2 <= 1;
              if ($273) {
                return pow(p2)(1 / alpha);
              }
              ;
              return negate2(log)((b2 - p2) / alpha);
            }();
            var ret = x * beta;
            var $274 = p2 > 1;
            if ($274) {
              var $275 = u4 <= pow(x)(alpha - 1);
              if ($275) {
                return pure13(ret);
              }
              ;
      ...
      ;
      throw new Error("Failed pattern match at Main (line 143, column 1 - line 143, column 50): " + [alpha.constructor.name, beta.constructor.name]);
    };
  };
  var choice = function(lst) {
    return bind22(pure13(length2(lst)))(function(len) {
      return bind22(consume)(function(u2) {
        var idx = round2(u2 * (toNumber(len) - 1));
        return pure13(fromJust3(index(lst)(idx)));
      });
    });
  };
  var betavariate = /* @__PURE__ */ bind32(ask2)(function(v) {
    return bind32(lift3(rgamma(v.alpha)(1)))(function(alpha_gamma) {
      return bind32(lift3(rgamma(v.beta)(1)))(function(beta_gamma) {
        return pure23(alpha_gamma / (alpha_gamma + beta_gamma));
      });
    });
  });
  var randStarPos = /* @__PURE__ */ bind32(ask2)(function(v) {
    return bind32(map110(function(v1) {
      return v1 * v.scale;
    })(betavariate))(function(distance) {
      return bind32(lift3(choice(v.orbits)))(function(orbit) {
        return bind32(lift3(consume))(function(time3) {
          var anchor = posOnCircle(orbit)(time3);
          return pure23(posOnCircle({
            center: anchor,
            radius: distance,
            rotationsPerTick: orbit.rotationsPerTick
          })(time3));
        });
      });
    });
  });
  var mkGalaxy = /* @__PURE__ */ function() {
    var mkWormhole = bind32(randStarIdx)(function(uid1) {
      return bind32(retryUnlessM2(function(a2) {
        return a2 !== uid1;
      })(randStarIdx))(function(uid2) {
        return pure23([uid1, uid2]);
      });
    });
    var mkStar = function(uid) {
      return bind32(map110(function(a2) {
        return round2(a2 * 50);
      })(lift3(consume)))(function(resources) {
        return bind32(randStarPos)(function(pos) {
          return pure23({
            uid,
            puid: Nothing.value,
            name: "Star" + show1(uid),
    ...
    return bind32(ask2)(function(v) {
      return bind32(traverse12(function(uid) {
        return map110(asHomeworld(uid))(mkStar(uid));
      })(range2(1)(v.playerCount)))(function(homeworlds) {
        return bind32(traverse12(mkStar)(range2(v.playerCount + 1 | 0)(v.starCount)))(function(otherworlds) {
          return bind32(traverse12($$const(mkWormhole))(range2(1)(v.wormholeCount)))(function(wormholes) {
            return pure23({
              stars: append13(homeworlds)(otherworlds),
              wormholes
            });
          });
        });
  ...
  var runStarMaker = function(config) {
    return function __do2() {
      var manyUniforms = replicateM2(5e3)(random)();
      var uniforms = cycle(manyUniforms);
      return unwrap5(flip(evalStateT2)(uniforms)(flip(runReaderT)(config)(mkGalaxy)));
    };
  };
  var _slider = /* @__PURE__ */ function() {
    return $$Proxy.value;
  }();
  var _display = /* @__PURE__ */ function() {
    return $$Proxy.value;
  }();
  var configInputs = function(dictMonadEffect) {
    var render = function(dictMonadEffect1) {
      var slider1 = slider(dictMonadEffect1);
      return function(state3) {
        return div_([div_([slot2(_slider)(0)(slider1)({
          label: "alpha",
          min: 0,
          max: 1,
          step: 1e-3,
          value: state3.config.alpha
        })(HandleSliderChange.create), slot2(_slider)(1)(slider1)({
          label: "beta",
          min: 0,
          max: 1,
          step: 1e-3,
          value: state3.config.beta
        })(HandleSliderChange.create), slot2(_slider)(2)(slider1)({
          label: "scale",
          min: 0,
          max: 20,
          step: 0.01,
          value: state3.config.scale
        })(HandleSliderChange.create), slot2(_slider)(3)(slider1)({
          label: "playerCount",
          min: 2,
          max: 50,
          step: 1,
          value: toNumber(state3.config.playerCount)
        })(HandleSliderChange.create), slot2(_slider)(4)(slider1)({
          label: "starCount",
          min: 2,
          max: 300,
          step: 1,
          value: toNumber(state3.config.starCount)
        })(HandleSliderChange.create), slot2(_slider)(5)(slider1)({
          label: "wormholeCount",
          min: 0,
          max: 300,
          step: 1,
          value: toNumber(state3.config.wormholeCount)
        })(HandleSliderChange.create)]), slot_2(_display)(0)(jsonDisplay)(state3.galaxyJson)]);
      };
    };
    var recalcGalaxy = function(config) {
      return bind5(validateConfig(config))(function() {
        return lift1(runStarMaker(config));
      });
    };
    var handleAction = function(dictMonadEffect1) {
      var liftEffect7 = liftEffect(monadEffectHalogenM(dictMonadEffect1));
      return function(action2) {
        return bind15(modify5(updateStateByLabel(action2.value0.value0)(action2.value0.value1)))(function(state3) {
          return bind15(liftEffect7(runExceptT(recalcGalaxy(state3.config))))(function(eitherGalaxy) {
            if (eitherGalaxy instanceof Left) {
              return modify_3(set3($$Proxy.value)(eitherGalaxy.value0));
            }
            ;
            if (eitherGalaxy instanceof Right) {
              return modify_3(set3($$Proxy.value)(writeJSON2(eitherGalaxy.value0)));
            }
            ;
            throw new Error("Failed pattern match at Main (line 370, column 19 - line 372, column 106): " + [eitherGalaxy.constructor.name]);
          });
        });
      };
    };
  ...
  var configInputs1 = /* @__PURE__ */ configInputs(monadEffectAff);
  var main2 = /* @__PURE__ */ runHalogenAff(/* @__PURE__ */ bind(bindAff)(awaitBody)(function(body2) {
    return runUI2(configInputs1)({
      config: defaultConfig,
      galaxyJson: "Fiddle with slides to begin generation"
    })(body2);
  }));
